...
const metrics = [
  {
    value: 25,
    displayValue: '25+',
    suffixKey: 'items.timeSaved.suffix',
    labelKey: 'items.timeSaved.label',
    footnoteKey: 'items.timeSaved.footnote',
    tooltipKey: 'items.timeSaved.tooltip',
  },
  {
    value: 45,
    displayValue: '45',
    suffixKey: 'items.errorReduction.suffix',
    labelKey: 'items.errorReduction.label',
    footnoteKey: 'items.errorReduction.footnote',
    tooltipKey: 'items.errorReduction.tooltip',
  },
  {
    value: 3,
    displayValue: '3',
    suffixKey: 'items.payback.suffix',
    labelKey: 'items.payback.label',
    footnoteKey: 'items.payback.footnote',
    tooltipKey: 'items.payback.tooltip',
  },
]
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {metrics.map((metric, index) => (
            <MetricCard key={index} metric={{
              ...metric,
              suffix: t(metric.suffixKey as any) as any,
              label: t(metric.labelKey as any) as any,
              footnote: t(metric.footnoteKey as any) as any,
              tooltip: t(metric.tooltipKey as any) as any,
            }} delay={index * 200} />
          ))}
        </div>
      </Container>
